export function calculateDetailScore(input) {
    let score = 0;
    const missing = [];
...
export function getMinDetailRequired(complexity, danger) {
    return MIN_DETAIL_MAP[`${complexity}:${danger}`] ?? 0;
}
export function evaluateBackburner(complexity, danger, input) {
...
export function recommendModel(complexity, danger, priority) {
...
//# sourceMappingURL=detail-score.js.map